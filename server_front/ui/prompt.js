steel.d("ui/prompt", ["utils/kit/extra/language","utils/kit/extra/reuse","utils/kit/dom/smartInput","utils/module/layer","ui/dialog"],function(require, exports, module) {
require("utils/kit/extra/language");
require("utils/kit/extra/reuse");
require("utils/kit/dom/smartInput");
	...
	var getPrompt = function(args){
		...
		if(!cache){
			cache = $.utils.kit.extra.reuse(function(){
				var pmt = $.utils.module.layer(lang(TEMP));
				pmt.input = $.utils.kit.dom.smartInput(pmt.getDom('input'));
				return pmt;
			});
		}
