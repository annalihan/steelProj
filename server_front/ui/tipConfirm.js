steel.d("ui/tipConfirm", ["ui/tipPrototype","utils/kit/extra/language"],function(require, exports, module) {
require("ui/tipPrototype");
...
STK.register('ui.tipConfirm', function($) {
	...
	return function(spec) {
		...
		spec.info = spec.info || $L('#L{确认要删除这条微博吗}？');
