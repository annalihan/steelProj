steel.d("utils/kit/dom/parentElementBy", [],function(require, exports, module) {
/**
 * 得到满足指定条件的某个祖先节点 
 * @id $.utils.kit.dom.parentElementBy
 ...
 * @example
	...
	var oPB = $.utils.kit.dom.parentElementBy($.E('#child'), document.HTMLElement, function (el) {
		if(el.title == 'kkk') {
			return true;
		}
	});
 */
STK.register('utils.kit.dom.parentElementBy',function($){
