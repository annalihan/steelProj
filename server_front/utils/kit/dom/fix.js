steel.d("utils/kit/dom/fix", ["utils/kit/dom/cssText"],function(require, exports, module) {
/**
 * node位置固定
 * @id  STK.kit.dom.fix
...
//require("core/obj/parseParam");
//require("core/dom/isNode");
//require("core/util/browser");
//require("core/util/winSize");
//require("core/util/scrollPos");
//require("core/arr/isArray");
//require("core/evt/addEvent");
//require("core/evt/removeEvent");
//require("core/evt/custEvent");
require("utils/kit/dom/cssText");

STK.register("utils.kit.dom.fix", function($) {
	//dom 扩展数据
	...
	function _draw(node, type, offset) {
		...
		var _position = "fixed", _top, _left, _right, _bottom
			...
			,_cssText = $.utils.kit.dom.cssText(node.style.cssText);
		if (!_canFix) {
			_position = 'absolute';
