steel.d("utils/kit/dom/btnState", ["utils/kit/dom/parseDOM","utils/kit/extra/language"],function(require, exports, module) {
/**
...
STK.register("utils.kit.dom.btnState" , function($) {
	/**
	 * spec说明
	 * 
	 * btn : 按钮
	...
	var changeTo = function(spec) {
		var getDom = function(dom) {
			var doms = $.utils.kit.dom.parseDOM($.builder(dom).list);
			if(!doms['submit_btn']) {
				doms['submit_btn'] = dom;				
			}
			return doms;
