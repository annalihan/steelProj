steel.d("utils/kit/io/cssLoader", [],function(require, exports, module) {
/**
...
STK.register('utils.kit.io.cssLoader', function($){
	...
	return function(url, load_ID, complete , giveVersion){
        ...
        if (!checkFileCache(url, complete)) 
            return;
        var fullUrl = CSSHOST + url + '?version=' + giveVersion;
        //css下载模块
		var link = $.C("link");
