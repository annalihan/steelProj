steel.d("utils/kit/io/jsonp", ["utils/kit/extra/merge"],function(require, exports, module) {
require("utils/kit/extra/merge");

STK.register('utils.kit.io.jsonp', function($) {
	/*** url			: 
	 -----------args-------------
	 * onComplete	: 
	 * onTraning	: 
	...
	return function(args){
		...
		var nextRequest = function(){
			...
			$.jsonp($.utils.kit.extra.merge(conf,{
				'args' : current.args,
