steel.d("utils/kit/extra/htmlFilter", [],function(require, exports, module) {
/**
 * html XSS 过滤
 * @author liusong@staff.sina.com.cn
 */
STK.register('utils.kit.extra.htmlFilter', function($){
	
	var  attrReg    = /([a-z\d-]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|([^\s]+)))?/ig
		,isOn       = /^on([a-z\d-]*)$/i
		,entiReg    = /&#(x?)([a-z\d]*);?/ig
		,killValMap = /(javascript|vbscript|expression|applet)/i
		,killTagMap = /^(audio|video|html|object|embed|param|body|head|form|script|iframe|expression|applet|meta|xml|blink|style|frame|frameset|ilayer|layer|bgsound|title|base)$/i;
