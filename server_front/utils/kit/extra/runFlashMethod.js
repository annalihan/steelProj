steel.d("utils/kit/extra/runFlashMethod", [],function(require, exports, module) {
/*
 * 解决运行flash方法时，flash未能加载完，导致运行失败的问题，采用轮询的方法处理
 * var flashObj = $.E('test');
 * var fileNum = 5 , fileSize = 100; 
 * $.utils.kit.extra.runFlashMethod(flashObj , 'setInitSize' , function() {
 * 		flashObj.setInitSize(fileNum , fileSize);
 * });
 */
STK.register('utils.kit.extra.runFlashMethod', function($){
