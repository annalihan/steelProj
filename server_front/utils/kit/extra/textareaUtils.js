steel.d("utils/kit/extra/textareaUtils", ["utils/kit/dom/isTurnoff"],function(require, exports, module) {
 ...
 */
STK.register('utils.kit.extra.textareaUtils',function($){
	...
	*/
	it.getCursorPos = function(obj){
		var CaretPos = 0;
        //IE 9、IE10下直接取selectionStart属性
		if (STK.core.util.browser.IE && !STK.core.util.browser.IE9) {
			!obj.disabled && obj.focus();
			var range = null;
