steel.d("utils/module/unitLayer", [],function(require, exports, module) {
/**
 * 层
 * @id STK.module.layer
...
STK.register('utils.module.unitLayer', function($){
    ...
    return function(template){
        ...
        var outer = dom.list['unitOuter'][0]
            ,inner = dom.list['unitInner'][0];
