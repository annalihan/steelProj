steel.d("utils/module/bubble", ["utils/module/layer","utils/kit/dom/layoutPos"],function(require, exports, module) {
require("utils/module/layer");
require("utils/kit/dom/layoutPos");

STK.register('utils.module.bubble', function($){
	...
	return function(temp, spec){
		...
		that.setLayout = function(el, opts){
			...
			$.utils.kit.dom.layoutPos(box, el, opts);
