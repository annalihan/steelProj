steel.d("utils/module/calendar", [],function(require, exports, module) {
/**
 * 提供方法用于快速使用json数据渲染日历模板
 */
STK.register("utils.module.calendar" , function($) {
	/**
	 * 返回给外层调用的句柄
	 */
	var calendar = {
		...
		*/
		 ...
		 *    var TEMPLATE = '<#et moodlist data><ul class="week clearfix W_linecolor"><li>日</li><li>一</li><li>二</li><li>三</li><li>四</li><li>五</li><li>六</li></ul><ul class="day clearfix">' + 
			   ...
			   '</#list>' + 
			   '</ul></#et>';
			  $.utils.module.calendar(new Date(2009,9,9) , [服务器json数组] , TEMPLATE); 
		 ...
		 * $.utils.module.calendar.parseMapHtml("2009-09-09" , list , TEMPLATE)
		 */
