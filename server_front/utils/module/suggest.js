steel.d("utils/module/suggest", [],function(require, exports, module) {
/**
...
STK.register('utils.module.suggest', function($){
	//静态指针
	var n       = null,
		ce      = $.custEvent,
		define  = ce.define,
	...
	var suggest = function(conf){
		...
		var clickHandler = function(event){
			...
			fire(cEvt, 'onSelect', [$.core.arr.indexOf(event.el, items()),textNode]);
		};
		//鼠标滑过事件管理
