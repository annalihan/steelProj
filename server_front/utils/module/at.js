steel.d("utils/module/at", ["utils/kit/dom/cssText","common/listener","utils/kit/extra/textareaUtils","utils/kit/dom/isTurnoff"],function(require, exports, module) {
require("utils/kit/dom/cssText");
require("common/listener");
require("utils/kit/extra/textareaUtils");
require("utils/kit/dom/isTurnoff");
...
STK.register('utils.module.at',function($){
	//全局常量定义
	var	w = window,
		d = document,
		bw = $.core.util.browser,
		font = 'font-family:Tahoma,宋体;',
		selectionStart = $.utils.kit.extra.textareaUtils.selectionStart;
	//默认参数设置
	var spec;
	//全局变量定义
	...
	var checkValue = function(){
		if($.utils.kit.dom.isTurnoff(spec.textEl)){
			clearInterval(clock)
			return;
		}
		//缓存发布器中的内容
