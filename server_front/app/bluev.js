steel.d("app/bluev", ["common/loading/tpl","common/pageError/logic","utils/bee"],function(require, exports, module) {
/**
 * 应用入口文件
 */
...
steel.config({
    ...
    router: [
            ...
            [pathnameAnalysis_online + 'infoconfirm', 'components/bluev/infoconfirm/ctrl'],//蓝V认证-信息确认
